...
const translations: Translations = {
  ...
  level2: { ar: 'المستوى الثاني: المفردات الأساسية', ko: '2단계: 기본 어휘' },
  level3: { ar: 'المستوى الثالث: المفردات المتقدمة', ko: '3단계: 고급 어휘' },
  level4: { ar: 'المستوى الرابع: الجمل الأساسية', ko: '4단계: 기본 문장' },
  level5: { ar: 'المستوى الخامس: الجمل المتقدمة', ko: '5단계: 고급 문장' },
  level6: { ar: 'المستوى السادس: جمل الحياة اليومية', ko: '6단계: 일상생활 문장' },
